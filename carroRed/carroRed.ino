...
void setup() {
  myservo.attach(14);  // attach servo on pin 14 to servo object
  Serial.begin(9600);
  pinMode(Echo, INPUT);
  pinMode(Trig, OUTPUT);
  pinMode(IN1, OUTPUT);
...
double ditanciaMaxima = 30.0;       // distancia de lejania desde la que empieza a actuar la NN
...
const int SPEED = 50;              // velocidad del coche de las 4 ruedas a la vez.
